...
## Project Structure
    ...
    ├── testapiautosetting_122970  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_122970`
...
2. Clone this repo and `cd testapiautosetting_122970`
